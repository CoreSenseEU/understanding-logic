## Types
### **strategy** `((`[**`modelet_set`**](modelet.md#modelet_set)` * `[**modelet**](modelet.md#modelet)`) > `**`$o`**`)` { #strategy data-toc-label='strategy' }
A succession of [exertions](exertion.md) of [engines](engine.md) connects [modelets](modelet.md#modelet).
